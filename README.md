...
### 購入画面
<img width="1440" alt="スクリーンショット 2022-04-13 11 05 45" src="https://user-images.githubusercontent.com/83070201/163119811-0bab04be-18dd-42b9-8e69-dfec9764b78e.png">

- 個人情報が全て入っていれば「購入を決定」が押せるようになる
- 「購入を決定」を押すと購入完了画面に移動する
